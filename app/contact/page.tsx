...
import { PhoneCall, Mail, MapPin, Clock, Instagram, MessageCircle, Send, CheckCircle } from "lucide-react"
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = `Hi! I'm interested in your services.%0A%0AName: ${formData.name}%0AEmail: ${formData.email}%0APhone: ${formData.phone}%0AService: ${formData.service}%0A%0AMessage: ${formData.message}`

      // Open WhatsApp with pre-filled message
      window.open(`https://wa.me/918847050076?text=${message}`, "_blank")
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-lg neon-pink">info@shelomgraphics.com</p>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-lg neon-yellow">Chandigarh, India</p>
                    <p className="text-gray-400 text-sm">Global shipping available</p>
                  </div>
                </div>
            ...
            <Card className="neon-card p-10 backdrop-blur-sm border border-cyan-400/30 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="fmcg">FMCG Packaging</option>
                ...
                <Button
                  ...
                  className="neon-button w-full bg-gradient-to-r from-cyan-500 to-pink-500 hover:from-cyan-600 hover:to-pink-600 text-white border-0 py-4 text-lg font-medium tracking-wide shadow-xl hover:shadow-2xl transition-all duration-300 neon-glow disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="space-y-6">
            <Card className="neon-card p-6 backdrop-blur-sm border border-cyan-400/20 hover:border-cyan-400/40 transition-all duration-300">
              ...
              <p className="text-gray-300">
                Our standard turnaround time is 3-5 business days for most projects. Rush orders can be completed in
                24-48 hours with additional charges.
              </p>
            </Card>
            ...
            <Card className="neon-card p-6 backdrop-blur-sm border border-pink-400/20 hover:border-pink-400/40 transition-all duration-300">
              <h3 className="text-lg font-semibold text-white mb-3 neon-pink">Do you offer design services?</h3>
              <p className="text-gray-300">
                Yes! Our in-house design team can create custom designs for your packaging and stickers. We also accept
            ...
            <Card className="neon-card p-6 backdrop-blur-sm border border-purple-400/20 hover:border-purple-400/40 transition-all duration-300">
              <h3 className="text-lg font-semibold text-white mb-3 neon-purple">What file formats do you accept?</h3>
              <p className="text-gray-300">
                We accept AI, EPS, PDF, PSD, PNG, and JPG files. For best results, we recommend vector formats like AI
                or EPS.
              </p>
            </Card>
            ...
            <Card className="neon-card p-6 backdrop-blur-sm border border-green-400/20 hover:border-green-400/40 transition-all duration-300">
              <h3 className="text-lg font-semibold text-white mb-3 neon-green">Do you ship internationally?</h3>
              <p className="text-gray-300">
                Yes, we offer international shipping to most countries. Shipping costs and delivery times vary by
                destination.
              </p>
            </Card>
          </div>
