        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="neon-card group p-8 hover:shadow-2xl transition-all duration-500 border border-gray-700/50 shadow-lg bg-gray-800/80 backdrop-blur-sm hover:bg-gray-800 hover:border-pink-700/50 hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg neon-glow">
                <Package className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 tracking-tight gradient-text">FMCG Packaging</h3>
              <p className="text-gray-300 mb-8 leading-relaxed">
                Creative and sustainable packaging solutions for fast-moving consumer goods, enhancing shelf appeal.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center text-sm text-gray-300">
            ...
            <Card className="neon-card group p-8 hover:shadow-2xl transition-all duration-500 border border-gray-700/50 shadow-lg bg-gray-800/80 backdrop-blur-sm hover:bg-gray-800 hover:border-yellow-700/50 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 tracking-tight gradient-text">Custom Stickers</h3>
              <p className="text-gray-300 mb-8 leading-relaxed">
                High-quality custom stickers for branding, decoration, and promotional purposes with vibrant colors.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center text-sm text-gray-300">
