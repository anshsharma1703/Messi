...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.open(`mailto:shelomgraphics2020@gmail.com?subject=${emailSubject}&body=${emailBody}`, "_blank")
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold gradient-text neon-text mb-2">30k+</div>
            ...
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold gradient-text neon-text mb-2">100%</div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-lg neon-pink">shelomgraphics2020@gmail.com</p>
