  ...
  const portfolioItems = [
    {
      ...
      image: "/pharmaceutical-packaging.png",
    ...
    },
    {
      ...
      description: "Eye-catching packaging designs for fast-moving consumer goods that stand out on retail shelves.",
      image: "/colorful-fmcg-packaging.png",
      icon: <Package className="w-6 h-6" />,
      color: "from-pink-500 to-purple-600",
    },
    {
      title: "Custom Sticker Collections",
      category: "Stickers",
      description: "Vibrant custom sticker designs featuring popular characters, themes, and branding elements.",
      image: "/colorful-custom-stickers.png",
    ...
    },
    {
      ...
      image: "/luxury-premium-packaging.png",
      icon: <Package className="w-6 h-6" />,
    ...
    },
    {
      ...
      category: "F&B",
      description: "Food-safe packaging solutions with attractive designs for restaurants and food brands.",
      image: "/diverse-food-beverage-packaging.png",
      icon: <Layers className="w-6 h-6" />,
    ...
    },
    {
      ...
      category: "Corporate",
      description: "Professional branding materials including business cards, letterheads, and promotional items.",
      image: "/corporate-branding-materials.png",
      icon: <Printer className="w-6 h-6" />,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white pt-16">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="group">
              ...
              <div className="text-gray-400 text-sm md:text-base font-medium tracking-wide">Design Categories</div>
            </div>
            <div className="group">
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 gradient-text">Ready to Create Something Amazing?</h2>
